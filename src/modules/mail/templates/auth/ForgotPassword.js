...
export function ForgotPassword({ firstName, otp }) {
  const greeting = firstName ? `Hi ${firstName},` : 'Hi there,';

  return e(Html, null,
    e(Head, null),
    e(Preview, null, `Your Odito password reset code is ${otp}`),
    e(Body, { style: { backgroundColor: '#f4f4f4', fontFamily: 'sans-serif', margin: 0, padding: '20px 0' } },
      e(Container, { style: { backgroundColor: '#ffffff', borderRadius: 10, padding: 30, maxWidth: 480, margin: '0 auto' } },
        ...
        e(Text, { style: { fontSize: 13, color: '#6b7280' } },
          'This code expires in 10 minutes. If you did not request a password reset, you can safely ignore this email — your password will not be changed.')
      )
    )
  );
}
